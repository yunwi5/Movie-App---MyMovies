...
const Signup: React.FC = () => {
    ...
    return (
        <form
            className={`auth-form ${
                formIsInvalid ? 'auth-form--invalid signup-form--invalid' : ''
            }`}
        ...
        >
            ...
            <div
                className={`username-wrapper wrapper ${
                    userNameState.valid ? '' : 'wrapper--invalid'
                }`}
            >
            ...
            <div
                className={`password-wrapper wrapper ${
                    passwordState.valid ? '' : 'wrapper--invalid'
                }`}
            >
