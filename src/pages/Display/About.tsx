	...
	return (
		<Fragment>
			<Helmet>
				...
				<meta name="description" content="Introducing services we provide in MyMovies" />
			</Helmet>
			<main className="about-page">
				...
				<section className="add-section">
					<div className="add-section__heading">
						...
						<p>
							One is importing existing movieovies from Movie Store, and the other is
							adding your new movie independently!
						</p>
					</div>
					<div className="add-section__container">
						...
						<div className="about-card">
							...
							<div className="text-content">
								...
								<p>
									Our Movie Store contains 100+ famoupopuler movies in the World
									for you to add those movies directly into your collection! Our
									store movies make sure to have all the necessary key information
									attached so that you don't need to find and add the information
									additionally.
								</p>
							</div>
						...
						<div className="about-card">
							...
							<div className="text-content">
								...
								<p>
									If the movie you want is not in the store, the other option is
									to add your own movie with Movie Form we prepared. You can add
									movies not currently existing in the store by using Movie Form
									to independently add your own favorite movies. Note that your
									custom movies will be totally independnet to our Store Movies.
								</p>
							</div>
					...
					<div className="add-section__footer">
						<p className="user-message">
							...
							&nbsp;{" "}
							<span>
								Note that you can add new movies by using the search bar of course!
							</span>
						</p>
						<p className="user-message">
							<FontAwesomeIcon
							...
							&nbsp;{" "}
							<span>
								We are currently implementing automatic addition of your custom
								movies by finding the key movie information using our search
								algorithm.
							</span>
						</p>
					</div>
				...
				<section className="manage-section">
					...
					<div className="manage-section__part sorting-part">
						...
						<div className="text-content">
							...
							<p>
								You can Sort the movies based on rating, released year and title,
								and you can Filter the movies based on rating and genres. By the
								way, you can either sort our store movies, or your collection
								movies!
							</p>
							<Link className="btn link" to={`/store-movies`}>
								<span>Have A Try</span>{" "}
								<FontAwesomeIcon className="icon" icon={faArrowRight as IconProp} />
							</Link>
						</div>
					</div>
					...
					<div className="manage-section__part detail-part">
						<div className="text-content">
							...
							<p>
								You can see all the details of the movie in the movie detail page.
								You can see the detail of either the store movie or your collection
								movie.
							</p>
					...
					<div className="manage-section__part edit-part">
						...
						<div className="text-content">
							...
							<div>
								...
								<p>
									To edit movies, you need to add movies to your collection first
									either from the store, or using the custom addition.
								</p>
							</div>
				...
				<section className="rating-section">
					...
					<div className="cards-wrapper">
						<div className="rating-card">
							...
							<h3>IMDb Ratings</h3>
							<p>
								Our store ratings are based on IMDb movies ratings. We included IMDb
								ratings as initial store ratings because so many people contributed
								to the IMDb ratings, and its average rating can be a goot indicator
								for you when sorting the movies according to the ratings.
							</p>
						</div>
						<div className="rating-card">
							...
							<h3>User Ratings</h3>
							<p>
								Note that if you collect movies from the store, initial ratings will
								be set to store IMDb ratings. You can of course adjust your ratings
								whenever you want.You can set your own ratings between 0 and 10. By
								the way, negative ratings are not supported in our app.
							</p>
						</div>
					</div>
				</section>
